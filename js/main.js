   /**
        ...
        function generarGraficoFuenteCitas(citasParaReportes) {
            ...
            const conteoFuente = {};
            const fuentesPosibles = ['whatsapp', 'llamada', 'tiktok', 'instagram', 'referido', 'otro'];
            fuentesPosibles.forEach(f => conteoFuente[f] = 0);

            citasParaReportes.forEach(cita => {
                const fuente = cita.fuente || 'otro';
                if (conteoFuente.hasOwnProperty(fuente)) {
                    conteoFuente[fuente]++;
                } else {
                    conteoFuente['otro']++;
                }
            ...
            const etiquetas = Object.keys(conteoFuente).map(f => capitalizar(f));
            const valores = Object.values(conteoFuente);
            ...
            fuenteCitasChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        data: valores,
                        backgroundColor: ['#25D366', '#3498db', '#010101', '#E4405F', '#f1c40f', '#95a5a6'],
                        borderColor: '#fff'
                    }]
                },
                options: {
        ...
        function abrirEditarModal(id) {
            ...
            if (cita) {
                ...
                document.getElementById('editarFuente').value = cita.fuente || 'otro';
        ...
        function guardarEdicion() {
            ...
            if (index !== -1) {
                ...
                citas[index] = {
                    ...
                    fuente: document.getElementById('editarFuente').value,
                    estado: nuevoEstado,
